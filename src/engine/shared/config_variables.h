...
MACRO_CONFIG_STR(ClAccountServer, cl_account_server, 128, "https://accounts.ddnet.org", CFGFLAG_CLIENT | CFGFLAG_SAVE, "URL of the DDNet account server used for login")
MACRO_CONFIG_INT(SvQuic, sv_quic, 0, 0, 1, CFGFLAG_SERVER, "Enable the experimental QUIC secure transport + accounts endpoint")
MACRO_CONFIG_STR(SvAccountServer, sv_account_server, 128, "https://accounts.ddnet.org", CFGFLAG_SERVER, "URL of the account server whose CA certs verify client account certificates")
MACRO_CONFIG_INT(SvQuicPort, sv_quic_port, 8313, 0, 65535, CFGFLAG_SERVER, "UDP port for the experimental QUIC secure transport + accounts endpoint")
