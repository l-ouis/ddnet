...
void CTargetSwitch::Snap(int SnappingClient)
{
	...
	if(SnappingClientVersion < VERSION_DDNET_TARGET)
	{
	...
	// GameServer()->SnapPickup(CSnapContext(SnappingClientVersion, Sixup), GetId(), m_Pos, 1, 1, 1, 0);
}
...
{
	log_info("server", "Hi a targetswtich got hit.");
