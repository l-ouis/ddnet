...
public:
	...
	void CreateTargetHit(vec2 Pos, CClientMask Mask = CClientMask().set());
	...
	bool SnapTargetSwitch(const CSnapContext &Context, int SnapId, const vec2 &Pos, int Type, int SwitchNumber, int SwitchDelay, int Flags = 0) const;
